...
export const ReusableTable = ({
  ...
  const filteredData = MainData.filter((data) => {
    // Pastikan bahwa data terdefinisi dan bukan null sebelum mengakses Object.values
    if (data) {
    ...
    return false; // Jika data undefined atau null, kembalikan false untuk filter
  });
