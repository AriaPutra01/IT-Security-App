...
func main() {
	...
	r.POST("/admin/users", controllers.AdminCreateUser)
	r.GET("/admin/users", controllers.AdminGetUsers)
	r.POST("/login", controllers.Login)
	r.GET("/getlogin", controllers.GetLoginView)
	r.GET("/getregister", controllers.GetRegisterView)
